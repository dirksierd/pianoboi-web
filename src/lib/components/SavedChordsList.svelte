					...
					<div class="flex items-center gap-2">
						...
						{#if chord.setId && chord.setId === currentSetId}
							<div class="flex items-center">
								<span class="ml-2 rounded-full bg-blue-100 px-2 py-0.5 text-xs text-blue-700">
...
{:else}
	<div class="flex h-full items-center justify-center">
		<div class="text-center text-gray-500">
			<p class="mb-2 text-lg font-medium">No saved chords</p>
			<p class="text-sm">Press the space bar to save your current chord</p>
		</div>
	</div>
{/if}
